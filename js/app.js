(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            if (!e.target.closest(".header__burger") && !e.target.closest(".icon-menu")) functions_menuClose();
        }));
    }
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new swiper_core_Swiper(".main-page__running-string", {
    ...
    parallax_Parallax.Each = class {
        constructor(parent) {
            ...
            this.offset = 0;
            this.value = 0;
            this.smooth = parent.dataset.prlxSmooth ? Number(parent.dataset.prlxSmooth) : 35;
            this.setEvents();
        }
        setEvents() {
    ...
    const s = (t, e) => String(t).toLowerCase().replace(/[\s/_.]+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+|-+$/g, "") || e || "", n = ({hash: t} = {}) => location.pathname + location.search + (t ? location.hash : ""), o = (t, e = {}) => {
        const s = i({
            url: t = t || n({
                hash: !0
            }),
    ...
    async function u(t, e = {}) {
        ...
        const {status: m, url: g} = u, f = await u.text();
        if (500 === m) throw this.hooks.call("fetch:error", n, {
            status: m,
            response: u,
            url: g
        }), new c(`Server error: ${g}`, {
            status: m,
            url: g
        });
        if (!f) throw new c(`Empty response: ${g}`, {
            status: m,
            url: g
        });
        const {url: v} = l.fromUrl(g), w = {
            url: v,
            html: f
        };
        return !n.cache.write || e.method && "GET" !== e.method || t !== v || this.cache.set(w.url, w), 
        w;
    }
    class d {
        constructor(t) {
    ...
    const p = (t, e = document) => e.querySelector(t), m = (t, e = document) => Array.from(e.querySelectorAll(t)), g = () => new Promise((t => {
        requestAnimationFrame((() => {
            requestAnimationFrame((() => {
                t();
            }));
    ...
    const y = t => window.CSS && window.CSS.escape ? CSS.escape(t) : t, k = t => 1e3 * Number(t.slice(0, -1).replace(",", "."));
    class b {
        constructor(t) {
    ...
    class P {
        ...
        parseCallArgs(t, e, i, s) {
            return e instanceof S || "object" != typeof e && "function" != typeof i ? [ e, i, s ] : [ void 0, e, i ];
        }
        async run(t, e, i) {
            const s = [];
        ...
        runSync(t, e, i) {
            ...
            for (const {hook: n, handler: o, defaultHandler: r, once: a} of t) {
                ...
                s.push(t), f(t) && console.warn(`Promise returned from handler for synchronous hook '${n}'.Swup will not wait for it to resolve.`);
            }
            return s;
        }
        getHandlers(t, e) {
    ...
    const U = t => {
        ...
        let i = document.getElementById(t) || document.getElementById(e) || p(`a[name='${y(t)}']`) || p(`a[name='${y(e)}']`);
        return i || "top" !== t || (i = document.body), i;
    }, C = "transition", $ = "animation";
    async function x({elements: t, selector: e}) {
        if (!1 === e && !t) return;
        let i = [];
        if (t) i = Array.from(t); else if (e && (i = m(e, document.body), !i.length)) return void console.warn(`[swup] No elements found matching animationSelector \`${e}\``);
        const s = i.map((t => function(t) {
            const {type: e, timeout: i, propCount: s} = function(t, e) {
                const i = window.getComputedStyle(t), s = A(i, `${C}Delay`), n = A(i, `${C}Duration`), o = H(s, n), r = A(i, `${$}Delay`), a = A(i, `${$}Duration`), l = H(r, a);
                let h = null, c = 0, u = 0;
                return c = Math.max(o, l), h = c > 0 ? o > l ? C : $ : null, u = h ? h === C ? n.length : a.length : 0, 
                {
                    type: h,
                    timeout: c,
                    propCount: u
            ...
            return !(!e || !i) && new Promise((n => {
                ...
                const l = () => {
                    ...
                    if (e.target === t) {
                        if (!function(t) {
                            return [ `${C}end`, `${$}end` ].includes(t.type);
                        }(e)) throw new Error("Not a transition or animation event.");
                        (performance.now() - r) / 1e3 < e.elapsedTime || ++a >= s && l();
                    }
                };
                setTimeout((() => {
                    a < s && l();
    ...
    function H(t, e) {
        ...
        return Math.max(...e.map(((e, i) => k(e) + k(t[i]))));
    }
    function q(t, e = {}, s = {}) {
    ...
    async function V(t, e = {}) {
        ...
        e.referrer = e.referrer || this.currentPageUrl, !1 === e.animate && (t.animation.animate = !1), 
        t.animation.animate || this.classes.clear();
        const a = e.history || (null == i ? void 0 : i.getAttribute("data-swup-history")) || void 0;
        a && [ "push", "replace" ].includes(a) && (t.history.action = a);
        const l = e.animation || (null == i ? void 0 : i.getAttribute("data-swup-animation")) || void 0;
        var h, c;
        l && (t.animation.name = l), "object" == typeof e.cache ? (t.cache.read = null != (h = e.cache.read) ? h : t.cache.read, 
        ...
        try {
            ...
            if (i.then((({html: e}) => {
                ...
                "replace" === t.history.action || t.to.url === this.currentPageUrl ? r(e) : (this.currentHistoryIndex++, 
                o(e, {
                    index: this.currentHistoryIndex
                }));
            }
            if (this.currentPageUrl = n(), t.history.popstate && this.classes.add("is-popstate"), 
            ...
            t.state = 9, console.error(e), this.options.skipPopStateHandling = () => (window.location.href = t.to.url + t.to.hash, 
            !0), window.history.go(-1);
        }
    }
    const I = async function(t) {
    ...
    }, L = function({html: t}, {containers: e} = this.options) {
        var i;
        const s = (new DOMParser).parseFromString(t, "text/html"), n = (null == (i = s.querySelector("title")) ? void 0 : i.innerText) || "";
        document.title = n;
        const o = m('[data-swup-persist]:not([data-swup-persist=""])'), r = e.map((t => {
            const e = document.querySelector(t), i = s.querySelector(t);
            return e && i ? (e.replaceWith(i), !0) : (e || console.warn(`[swup] Container missing in current document: ${t}`), 
            i || console.warn(`[swup] Container missing in incoming document: ${t}`), !1);
        })).filter(Boolean);
        return o.forEach((t => {
        ...
        t.advance(6);
        const {url: i} = e;
        this.classes.remove("is-leaving"), this.isSameResolvedUrl(n(), i) || (r(i), this.currentPageUrl = n(), 
        t.to.url = this.currentPageUrl), t.animation.animate && this.classes.add("is-rendering"), 
        await this.hooks.call("content:replace", t, {
            page: e
        }, ((t, {page: e}) => {
            if (!this.replaceContent(e, {
    ...
    class _ {
        constructor(t = {}) {
            var e, s;
            this.version = "4.5.0", this.options = void 0, this.defaults = B, this.plugins = [], 
            this.visit = void 0, this.cache = void 0, this.hooks = void 0, this.classes = void 0, 
            this.currentPageUrl = n(), this.currentHistoryIndex = void 0, this.clickDelegate = void 0, 
            this.navigating = !1, this.onVisitEnd = void 0, this.use = O, this.unuse = D, this.findPlugin = M, 
            this.log = () => {}, this.navigate = q, this.performNavigation = V, this.createVisit = E, 
            this.delegateEvent = a, this.fetchPage = u, this.awaitAnimations = x, this.renderPage = N, 
            this.replaceContent = L, this.animatePageIn = T, this.animatePageOut = I, this.scrollToContent = R, 
            this.getAnchorElement = U, this.getCurrentUrl = n, this.resolveUrl = W, this.isSameResolvedUrl = j, 
            this.options = i({}, this.defaults, t), this.handleLinkClick = this.handleLinkClick.bind(this), 
            this.handlePopState = this.handlePopState.bind(this), this.cache = new d(this), 
            this.classes = new b(this), this.hooks = new P(this), this.visit = this.createVisit({
                to: ""
            }), this.currentHistoryIndex = null != (e = null == (s = history.state) ? void 0 : s.index) ? e : 1, 
        ...
        async enable() {
            ...
            "swup" !== (null == (t = history.state) ? void 0 : t.source) && r(null, {
                index: this.currentHistoryIndex
            }), await g(), await this.hooks.call("enable", void 0, void 0, (() => {
        ...
        handlePopState(t) {
            var e, i, s, o;
            const r = null != (e = null == (i = t.state) ? void 0 : i.url) ? e : location.href;
    ...
    const items = gsap.utils.toArray(".benefits__item");
    ...
    items.forEach(((item, index) => {
        ScrollTrigger.create({
            ...
            onLeaveBack: () => {
                ...
                if (index > 0) items[index - 1].classList.add("active");
            }
        });
    }));
    const links = document.querySelectorAll(".main-page__links a");
    const imageBlocks = document.querySelectorAll(".block-images");
    function resetImages() {
        imageBlocks.forEach((block => {
            block.classList.remove("active");
            const images = block.querySelectorAll("img");
            images.forEach(((img, index) => {
                img.classList.remove("img-left-out", "img-right-out");
                if (index === 0) img.classList.add("img-left-out"); else if (index === images.length - 1) img.classList.add("img-right-out"); else img.classList.add("img-left-out");
            }));
        }));
    }
    function activateImageBlock(index) {
        resetImages();
        const targetBlock = document.querySelector(`.images-0${index + 1}`);
        if (targetBlock) {
            const images = targetBlock.querySelectorAll("img");
            images.forEach((img => {
                img.classList.remove("img-left-out", "img-right-out");
            }));
